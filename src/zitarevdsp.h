...
Compilation options: -a faust2header.cpp -lang cpp -i -inpl -cn zitarevdsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class zitarevdsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a faust2header.cpp -lang cpp -i -inpl -cn zitarevdsp -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow16 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow14) / zitarevdsp_faustpower2_f(fSlow15) + -1.0f));
		...
		float fSlow30 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow28) / zitarevdsp_faustpower2_f(fSlow29) + -1.0f));
		...
		float fSlow39 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow37) / zitarevdsp_faustpower2_f(fSlow38) + -1.0f));
		...
		float fSlow48 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow46) / zitarevdsp_faustpower2_f(fSlow47) + -1.0f));
		...
		float fSlow57 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow55) / zitarevdsp_faustpower2_f(fSlow56) + -1.0f));
		...
		float fSlow66 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow64) / zitarevdsp_faustpower2_f(fSlow65) + -1.0f));
		...
		float fSlow75 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow73) / zitarevdsp_faustpower2_f(fSlow74) + -1.0f));
		...
		float fSlow84 = std::sqrt(std::max<float>(0.0f, zitarevdsp_faustpower2_f(fSlow82) / zitarevdsp_faustpower2_f(fSlow83) + -1.0f));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp3 = (0.600000024f * fRec12[1] + fVec2[(IOTA0 - iConst8) & 32767]) - fTemp2;
			...
			float fTemp4 = (0.600000024f * fRec16[1] + fVec4[(IOTA0 - iConst14) & 32767]) - fTemp2;
			...
			float fTemp5 = fVec6[(IOTA0 - iConst19) & 16383] + fTemp2 + 0.600000024f * fRec20[1];
			...
			float fTemp6 = fTemp2 + 0.600000024f * fRec24[1] + fVec8[(IOTA0 - iConst24) & 32767];
			...
			float fTemp8 = fVec10[(IOTA0 - iConst29) & 16383] - (fTemp7 + 0.600000024f * fRec28[1]);
			...
			float fTemp9 = fVec12[(IOTA0 - iConst34) & 16383] - (fTemp7 + 0.600000024f * fRec32[1]);
			...
			float fTemp10 = (fTemp7 + fVec14[(IOTA0 - iConst39) & 16383]) - 0.600000024f * fRec36[1];
			...
			float fTemp11 = (fVec16[(IOTA0 - iConst44) & 16383] + fTemp7) - 0.600000024f * fRec40[1];
			...
			output0[i0] = FAUSTFLOAT(fRec0[0] * (0.5f * fRec1[0] * (fTemp24 + fRec2[2] + fTemp22 + fTemp23 + fSlow3 * ((fTemp24 + fTemp23 + fRec2[2]) - fTemp22)) + fTemp0 * fTemp25));
			...
			output1[i0] = FAUSTFLOAT(fRec0[0] * (0.5f * fRec1[0] * (fTemp31 + fRec44[2] + fTemp29 + fTemp30 + fSlow3 * ((fTemp31 + fTemp30 + fRec44[2]) - fTemp29)) + fTemp1 * fTemp25));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec15[1] = fRec15[0];
