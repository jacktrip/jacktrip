...
class zitarevdsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider1, "tooltip", "Dry/Wet Mix: -1 = dry, 1 = wet");
		ui_interface->addVerticalSlider("Wet", &fVslider1, 0.0f, -1.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT((0.5f * (fRec0[0] * ((fTemp0 * fTemp2) + (fTemp3 * ((fTemp26 + (fRec2[2] + (fTemp24 + fTemp25))) + (fSlow3 * ((fTemp26 + (fTemp25 + fRec2[2])) - fTemp24))))))));
			...
			output1[i] = FAUSTFLOAT((0.5f * (fRec0[0] * ((fTemp1 * fTemp2) + (fTemp3 * ((fTemp32 + (fRec44[2] + (fTemp30 + fTemp31))) + (fSlow3 * ((fTemp32 + (fTemp31 + fRec44[2])) - fTemp30))))))));
			IOTA = (IOTA + 1);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec15[1] = fRec15[0];
