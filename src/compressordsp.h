...
Compilation options: -a faust2header.cpp -lang cpp -i -inpl -cn compressordsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class compressordsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = 1.0f / float(fHslider1) + -1.0f;
		float fSlow3 = std::max<float>(fConst0, 0.00100000005f * float(fHslider2));
		int iSlow4 = fSlow3 < 1.1920929e-07f;
		...
		int iSlow7 = fSlow6 < 1.1920929e-07f;
		...
		int iSlow11 = fSlow10 < 1.1920929e-07f;
