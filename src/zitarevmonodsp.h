...
class zitarevmonodsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow8 = zitarevmonodsp_faustpower2_f(fSlow7);
		...
		float fSlow13 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow10) / zitarevmonodsp_faustpower2_f(fSlow11)) + -1.0f)));
		...
		float fSlow23 = zitarevmonodsp_faustpower2_f(fSlow22);
		float fSlow24 = (1.0f - (fSlow23 * fSlow9));
		float fSlow25 = (1.0f - fSlow23);
		float fSlow26 = (fSlow24 / fSlow25);
		float fSlow27 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow24) / zitarevmonodsp_faustpower2_f(fSlow25)) + -1.0f)));
		...
		float fSlow32 = zitarevmonodsp_faustpower2_f(fSlow31);
		float fSlow33 = (1.0f - (fSlow32 * fSlow9));
		float fSlow34 = (1.0f - fSlow32);
		float fSlow35 = (fSlow33 / fSlow34);
		float fSlow36 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow33) / zitarevmonodsp_faustpower2_f(fSlow34)) + -1.0f)));
		...
		float fSlow41 = zitarevmonodsp_faustpower2_f(fSlow40);
		float fSlow42 = (1.0f - (fSlow41 * fSlow9));
		float fSlow43 = (1.0f - fSlow41);
		float fSlow44 = (fSlow42 / fSlow43);
		float fSlow45 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow42) / zitarevmonodsp_faustpower2_f(fSlow43)) + -1.0f)));
		...
		float fSlow50 = zitarevmonodsp_faustpower2_f(fSlow49);
		float fSlow51 = (1.0f - (fSlow50 * fSlow9));
		float fSlow52 = (1.0f - fSlow50);
		float fSlow53 = (fSlow51 / fSlow52);
		float fSlow54 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow51) / zitarevmonodsp_faustpower2_f(fSlow52)) + -1.0f)));
		...
		float fSlow59 = zitarevmonodsp_faustpower2_f(fSlow58);
		float fSlow60 = (1.0f - (fSlow59 * fSlow9));
		float fSlow61 = (1.0f - fSlow59);
		float fSlow62 = (fSlow60 / fSlow61);
		float fSlow63 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow60) / zitarevmonodsp_faustpower2_f(fSlow61)) + -1.0f)));
		...
		float fSlow68 = zitarevmonodsp_faustpower2_f(fSlow67);
		float fSlow69 = (1.0f - (fSlow68 * fSlow9));
		float fSlow70 = (1.0f - fSlow68);
		float fSlow71 = (fSlow69 / fSlow70);
		float fSlow72 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow69) / zitarevmonodsp_faustpower2_f(fSlow70)) + -1.0f)));
		...
		float fSlow77 = zitarevmonodsp_faustpower2_f(fSlow76);
		float fSlow78 = (1.0f - (fSlow77 * fSlow9));
		float fSlow79 = (1.0f - fSlow77);
		float fSlow80 = (fSlow78 / fSlow79);
		float fSlow81 = std::sqrt(std::max<float>(0.0f, ((zitarevmonodsp_faustpower2_f(fSlow78) / zitarevmonodsp_faustpower2_f(fSlow79)) + -1.0f)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = (0.300000012f * fVec0[((IOTA - iSlow21) & 16383)]);
			float fTemp2 = (((0.600000024f * fRec11[1]) + fVec1[((IOTA - iConst6) & 32767)]) - fTemp1);
			fVec2[(IOTA & 2047)] = fTemp2;
			fRec11[0] = fVec2[((IOTA - iConst8) & 2047)];
			float fRec12 = (0.0f - (0.600000024f * fTemp2));
			fRec18[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec18[1]) - (fRec6[1] + fRec6[2]))));
			fRec17[0] = ((fSlow28 * fRec17[1]) + (fSlow29 * (fRec6[1] + (fSlow30 * fRec18[0]))));
			fVec3[(IOTA & 32767)] = ((0.353553385f * fRec17[0]) + 9.99999968e-21f);
			float fTemp3 = (((0.600000024f * fRec15[1]) + fVec3[((IOTA - iConst12) & 32767)]) - fTemp1);
			fVec4[(IOTA & 4095)] = fTemp3;
			fRec15[0] = fVec4[((IOTA - iConst13) & 4095)];
			float fRec16 = (0.0f - (0.600000024f * fTemp3));
			fRec22[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec22[1]) - (fRec8[1] + fRec8[2]))));
			fRec21[0] = ((fSlow37 * fRec21[1]) + (fSlow38 * (fRec8[1] + (fSlow39 * fRec22[0]))));
			fVec5[(IOTA & 16383)] = ((0.353553385f * fRec21[0]) + 9.99999968e-21f);
			float fTemp4 = (fVec5[((IOTA - iConst17) & 16383)] + (fTemp1 + (0.600000024f * fRec19[1])));
			fVec6[(IOTA & 4095)] = fTemp4;
			fRec19[0] = fVec6[((IOTA - iConst18) & 4095)];
			float fRec20 = (0.0f - (0.600000024f * fTemp4));
			fRec26[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec26[1]) - (fRec4[1] + fRec4[2]))));
			fRec25[0] = ((fSlow46 * fRec25[1]) + (fSlow47 * (fRec4[1] + (fSlow48 * fRec26[0]))));
			fVec7[(IOTA & 32767)] = ((0.353553385f * fRec25[0]) + 9.99999968e-21f);
			float fTemp5 = (fVec7[((IOTA - iConst22) & 32767)] + (fTemp1 + (0.600000024f * fRec23[1])));
			fVec8[(IOTA & 4095)] = fTemp5;
			fRec23[0] = fVec8[((IOTA - iConst23) & 4095)];
			float fRec24 = (0.0f - (0.600000024f * fTemp5));
			fRec30[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec30[1]) - (fRec9[1] + fRec9[2]))));
			fRec29[0] = ((fSlow55 * fRec29[1]) + (fSlow56 * (fRec9[1] + (fSlow57 * fRec30[0]))));
			fVec9[(IOTA & 16383)] = ((0.353553385f * fRec29[0]) + 9.99999968e-21f);
			float fTemp6 = (fVec9[((IOTA - iConst27) & 16383)] - (fTemp1 + (0.600000024f * fRec27[1])));
			fVec10[(IOTA & 2047)] = fTemp6;
			fRec27[0] = fVec10[((IOTA - iConst28) & 2047)];
			float fRec28 = (0.600000024f * fTemp6);
			fRec34[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec34[1]) - (fRec5[1] + fRec5[2]))));
			fRec33[0] = ((fSlow64 * fRec33[1]) + (fSlow65 * (fRec5[1] + (fSlow66 * fRec34[0]))));
			fVec11[(IOTA & 16383)] = ((0.353553385f * fRec33[0]) + 9.99999968e-21f);
			float fTemp7 = (fVec11[((IOTA - iConst32) & 16383)] - (fTemp1 + (0.600000024f * fRec31[1])));
			fVec12[(IOTA & 4095)] = fTemp7;
			fRec31[0] = fVec12[((IOTA - iConst33) & 4095)];
			float fRec32 = (0.600000024f * fTemp7);
			fRec38[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec38[1]) - (fRec7[1] + fRec7[2]))));
			fRec37[0] = ((fSlow73 * fRec37[1]) + (fSlow74 * (fRec7[1] + (fSlow75 * fRec38[0]))));
			fVec13[(IOTA & 16383)] = ((0.353553385f * fRec37[0]) + 9.99999968e-21f);
			float fTemp8 = ((fTemp1 + fVec13[((IOTA - iConst37) & 16383)]) - (0.600000024f * fRec35[1]));
			fVec14[(IOTA & 4095)] = fTemp8;
			fRec35[0] = fVec14[((IOTA - iConst38) & 4095)];
			float fRec36 = (0.600000024f * fTemp8);
			fRec42[0] = (0.0f - (fSlow19 * ((fSlow20 * fRec42[1]) - (fRec3[1] + fRec3[2]))));
			fRec41[0] = ((fSlow82 * fRec41[1]) + (fSlow83 * (fRec3[1] + (fSlow84 * fRec42[0]))));
			fVec15[(IOTA & 16383)] = ((0.353553385f * fRec41[0]) + 9.99999968e-21f);
			float fTemp9 = ((fVec15[((IOTA - iConst42) & 16383)] + fTemp1) - (0.600000024f * fRec39[1]));
			fVec16[(IOTA & 2047)] = fTemp9;
			fRec39[0] = fVec16[((IOTA - iConst43) & 2047)];
			float fRec40 = (0.600000024f * fTemp9);
			float fTemp10 = (fRec39[1] + fRec35[1]);
			float fTemp11 = (fRec27[1] + (fTemp10 + fRec31[1]));
			fRec3[0] = (fRec12 + (fRec16 + (fRec20 + (fRec24 + (fRec28 + (fRec32 + (fRec36 + (fRec40 + (fRec11[1] + (fRec15[1] + (fRec19[1] + (fTemp11 + fRec23[1]))))))))))));
			fRec4[0] = ((fRec28 + (fRec32 + (fRec36 + (fRec40 + fTemp11)))) - (fRec12 + (fRec16 + (fRec20 + (fRec24 + (fRec11[1] + ((fRec23[1] + fRec19[1]) + fRec15[1])))))));
			float fTemp12 = (fRec31[1] + fRec27[1]);
			fRec5[0] = ((fRec20 + (fRec24 + (fRec36 + (fRec40 + (fRec19[1] + (fTemp10 + fRec23[1])))))) - (fRec12 + (fRec16 + (fRec28 + (fRec32 + (fRec11[1] + (fTemp12 + fRec15[1])))))));
			fRec6[0] = ((fRec12 + (fRec16 + (fRec36 + (fRec40 + (fRec11[1] + (fTemp10 + fRec15[1])))))) - (fRec20 + (fRec24 + (fRec28 + (fRec32 + (fRec19[1] + (fTemp12 + fRec23[1])))))));
			float fTemp13 = (fRec39[1] + fRec31[1]);
			float fTemp14 = (fRec35[1] + fRec27[1]);
			fRec7[0] = ((fRec16 + (fRec24 + (fRec32 + (fRec40 + (fRec15[1] + (fRec23[1] + fTemp13)))))) - (fRec12 + (fRec20 + (fRec28 + (fRec36 + (fRec11[1] + (fRec19[1] + fTemp14)))))));
			fRec8[0] = ((fRec12 + (fRec20 + (fRec32 + (fRec40 + (fRec11[1] + (fRec19[1] + fTemp13)))))) - (fRec16 + (fRec24 + (fRec28 + (fRec36 + (fRec15[1] + (fRec23[1] + fTemp14)))))));
			float fTemp15 = (fRec39[1] + fRec27[1]);
			float fTemp16 = (fRec35[1] + fRec31[1]);
			fRec9[0] = ((fRec12 + (fRec24 + (fRec28 + (fRec40 + (fRec11[1] + (fRec23[1] + fTemp15)))))) - (fRec16 + (fRec20 + (fRec32 + (fRec36 + (fRec15[1] + (fRec19[1] + fTemp16)))))));
			fRec10[0] = ((fRec16 + (fRec20 + (fRec28 + (fRec40 + (fRec15[1] + (fRec19[1] + fTemp15)))))) - (fRec12 + (fRec24 + (fRec32 + (fRec36 + (fRec11[1] + (fRec23[1] + fTemp16)))))));
			float fTemp17 = (0.370000005f * (fRec4[0] + fRec5[0]));
			float fTemp18 = (fSlow89 * fRec43[1]);
			fRec43[0] = (fTemp17 - (fTemp18 + (fSlow88 * fRec43[2])));
			float fTemp19 = ((fSlow88 * fRec43[0]) + (fTemp18 + fRec43[2]));
			float fTemp20 = (0.5f * ((fTemp17 + fTemp19) + (fSlow86 * (fTemp19 - fTemp17))));
			...
			float fTemp24 = (0.370000005f * (fRec4[0] - fRec5[0]));
			float fTemp25 = (fSlow89 * fRec45[1]);
			fRec45[0] = (fTemp24 - (fTemp25 + (fSlow88 * fRec45[2])));
			float fTemp26 = ((fSlow88 * fRec45[0]) + (fTemp25 + fRec45[2]));
			float fTemp27 = (0.5f * ((fTemp24 + fTemp26) + (fSlow86 * (fTemp26 - fTemp24))));
