...
Compilation options: -a faust2header.cpp -lang cpp -i -inpl -cn zitarevmonodsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class zitarevmonodsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a faust2header.cpp -lang cpp -i -inpl -cn zitarevmonodsp -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Wet", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.00999999978f));
		ui_interface->declare(&fVslider0, "2", "");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->declare(&fVslider0, "tooltip", "Output scale   factor");
		ui_interface->declare(&fVslider0, "unit", "dB");
		ui_interface->addVerticalSlider("Level", &fVslider0, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-70.0f), FAUSTFLOAT(20.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow16 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow14) / zitarevmonodsp_faustpower2_f(fSlow15) + -1.0f));
		...
		int iSlow25 = int(std::min<float>(8192.0f, fConst9 * float(fVslider10)));
		...
		float fSlow30 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow28) / zitarevmonodsp_faustpower2_f(fSlow29) + -1.0f));
		...
		float fSlow39 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow37) / zitarevmonodsp_faustpower2_f(fSlow38) + -1.0f));
		...
		float fSlow48 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow46) / zitarevmonodsp_faustpower2_f(fSlow47) + -1.0f));
		...
		float fSlow57 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow55) / zitarevmonodsp_faustpower2_f(fSlow56) + -1.0f));
		...
		float fSlow66 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow64) / zitarevmonodsp_faustpower2_f(fSlow65) + -1.0f));
		...
		float fSlow75 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow73) / zitarevmonodsp_faustpower2_f(fSlow74) + -1.0f));
		...
		float fSlow84 = std::sqrt(std::max<float>(0.0f, zitarevmonodsp_faustpower2_f(fSlow82) / zitarevmonodsp_faustpower2_f(fSlow83) + -1.0f));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = (0.600000024f * fRec12[1] + fVec1[(IOTA0 - iConst8) & 32767]) - fTemp1;
			...
			float fTemp3 = (0.600000024f * fRec16[1] + fVec3[(IOTA0 - iConst14) & 32767]) - fTemp1;
			...
			float fTemp4 = fVec5[(IOTA0 - iConst19) & 16383] + fTemp1 + 0.600000024f * fRec20[1];
			...
			float fTemp5 = fVec7[(IOTA0 - iConst24) & 32767] + fTemp1 + 0.600000024f * fRec24[1];
			...
			float fTemp6 = fVec9[(IOTA0 - iConst29) & 16383] - (fTemp1 + 0.600000024f * fRec28[1]);
			...
			float fTemp7 = fVec11[(IOTA0 - iConst34) & 16383] - (fTemp1 + 0.600000024f * fRec32[1]);
			...
			float fTemp8 = (fTemp1 + fVec13[(IOTA0 - iConst39) & 16383]) - 0.600000024f * fRec36[1];
			...
			float fTemp9 = (fVec15[(IOTA0 - iConst44) & 16383] + fTemp1) - 0.600000024f * fRec40[1];
			...
			output0[i0] = FAUSTFLOAT(fRec0[0] * (0.5f * fRec1[0] * (fTemp22 + fRec2[2] + fTemp20 + fTemp21 + fSlow3 * ((fTemp22 + fTemp21 + fRec2[2]) - fTemp20)) + fTemp23 + fTemp23 + 0.5f * fRec1[0] * (fTemp29 + fRec44[2] + fTemp27 + fTemp28 + fSlow3 * ((fTemp29 + fTemp28 + fRec44[2]) - fTemp27))));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec15[1] = fRec15[0];
