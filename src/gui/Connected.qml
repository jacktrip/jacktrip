    ...
    Item {
        ...
        Item {
            ...
            Text {
                ...
                text:`<a style="color: ${textColour};" href="https://${virtualstudio.apiHost}/studios/${virtualstudio.currentStudio?start=true >= 0 ? serverModel[virtualstudio.currentStudio].id : ""}/live">Change Settings and Start</a>`
