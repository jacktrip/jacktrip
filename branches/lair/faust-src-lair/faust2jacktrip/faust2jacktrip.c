...
char *jacktrip_faust_template[] = {
#include "jacktrip_faust.template.h"
NULL
};
...
FILE *out = 0;
// cc -- no chars in array, they're sticky
char dspname[256] = "";
int in_widget = 0;
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 2) {
        printf("Usage: faust2jacktrip <filename.dsp.xml>\n");
        rc = 1;
        goto error;
    }
    ...
    do_template(jacktrip_faust_template);
